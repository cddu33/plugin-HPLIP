  ...
  */
  ...
  public function postSave() {
    ...
    if ($this->getConfiguration('ip')!="" && $this->getConfiguration('installer')!='OK') {
      ...
      passthru('sudo hp-setup -i -a -x ' . this::getConfiguration("ip") . ' '. jeedom::getTmpFolder(__CLASS__) . '/dependency > ' . log::getPathToLog(__CLASS__) . ' 2>&1 &');
  ...
  public function preRemove() {
    passthru('sudo hp-setup -i -a -r ' . this::getConfiguration("ip") . ' '. jeedom::getTmpFolder(__CLASS__) . '/dependency > ' . log::getPathToLog(__CLASS__) . ' 2>&1 &');
